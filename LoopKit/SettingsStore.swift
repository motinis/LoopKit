...
extension StoredSettings: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.init(date: try container.decode(Date.self, forKey: .date),
                  ...
                  sleepSchedule: try container.decodeIfPresent(DateInterval.self, forKey: .sleepSchedule).map{SleepSchedule($0)},
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(sleepSchedule?.asDateInterval(), forKey: .sleepSchedule)
